export default {
  ...
  memberShip: {
    ...
    desc: {
      level1: '<h4>What you get:</h4>              <p><i class="fal fa-check"></i> US members: ${referralReward} credit every time you refer a friend.</p>              <p><i class="fal fa-check"></i> {referralFlexReward}% of all earned interest from Instant-access investing accounts of referred friends during their first year.</p>            <p><i class="fal fa-check"></i> 1,000 Membership points.</p>',
      level2: '<h4>What you get:</h4>              <p><i class="fal fa-check"></i> ${cashback} credit to your MyConstant account the first time you reach Platinum (after leaving a review on Trustpilot).</p>              <p><i class="fal fa-check"></i> US members: ${referralReward} credit every time you refer a friend.</p>              <p><i class="fal fa-check"></i> {referralFlexReward}% of all earned interest from Instant-access investing accounts of referred friends during their first year.</p>            ',
      level3: '<h4>What you get:</h4>              <p><i class="fal fa-check"></i> ${cashback} credit to your MyConstant account the first time you reach Diamond (after leaving a review on Trustpilot).</p>              <p><i class="fal fa-check"></i> US members: ${referralReward} credit every time you refer a friend.</p>              <p><i class="fal fa-check"></i> {referralFlexReward}% of all earned interest from Instant-access investing accounts of referred friends during their first year.</p>              <p><i class="fal fa-check"></i> Up to 6 ACH transfers per month.</p>              <p><i class="fal fa-check"></i> {bonus} STAR token to redeem for a {bonus}% bonus or discounted interest.</p>            '
    },
  ...
  me: {
    ...
    proSaving: {
      listApplications: {
        ...
        noMoreLoans: 'Request your fixed rate loan here.',
  ...
  headerBar: {
    ...
    extraMenuMobile: {
      ...
      depositFiat: {
        title: 'Deposit USD',
        desc: 'Automatic {percent}% APY.<br/>Withdraw anytime. No fees.',
      },
      investFlex: {
        title: 'Flex',
      ...
      investLO: {
        title: 'Loan Originator',
        desc: 'Earn up to 11% APR. Terms from 6-15 months. \nIncludes loan originator’s buy-back guarantee \nin case of default.'
      },
      borrow: {
        title: 'Borrow',
        desc: '          <p>Get cash for crypto without needing to sell.</p>        '
      ...
      pro: {
        desc: 'Track rates. Buy and sell investments.'
      }
    }
  },
  ourPress: {
    ...
    howItWorks: {
      ...
      data: {
        ...
        '1': {
          ...
          desc: 'Borrowers must put up to 200% of the loan amount in <a class="glossary-word">cryptocurrency</a> or a portfolio of cryptocurrencies to obtain the loan.',
        },
      }
    },
    banner: {
      ...
      invest: {
        ...
        cap: '          <div class="row">            <div class="col">              Interest rate              <strong class="rate">Up to {rate}%</strong>            </div>            <div class="col">              Loan term              <strong>1-6 <span>months</span></strong>            </div>          </div>          <p class="clearBottom text-left">All lending backed by digital assets</p>        ',
        btn: 'Explore',
        desc: "All lending secured by\ndigital assets",
        new_title: "INVEST\nCrypto-backed",
      },
      loanOriginator: {
      ...
      borrow: {
        ...
        cap: '          <div class="row">            <div class="col">              Interest rate              <strong class="rate">From {rate}%</strong>            </div>            <div class="col">              Loan term              <strong>1-6 <span>months</span></strong>            </div>          </div>          <p class="clearBottom text-left">            Borrow against {numCollateral}+ cryptocurrencies          </p>        ',
        btn: 'Explore',
      ...
      data: {
        ...
        2: {
          ...
          desc: `
            ...
            <a href="https://blog.myconstant.com/how-constant-protects-money-and-collateral" target="_blank">How we protect you</a>
          `,
        },
        3: {
          title: 'No fees',
    ...
    howItWorks: {
      ...
      data: {
        0: {
          ...
          desc: 'Choose instant access or a fixed term of 30, 60, or 180 days.',
        },
        1: {
          title: '2. Deposit your funds',
  ...
  depositFiat: {
    ...
    faqs: {
      ...
      1: {
        ...
        answer: `
          <p>Your balance earns 4% APY by default through <a href="/flex" class="underline">Instant-access investing</a>, our anytime-withdrawal investment account. If you’d prefer not to use Instant-access investing, you can disable it from <a href="/accounts" class="underline">your Accounts page</a> (under Accounts detail).</p>
          <p>Disabling Instant-access investing means your money will remain with Prime Trust, our accredited US custodian, who will store your funds across multiple insured bank accounts to an aggregate limit of $130,000,000. You will be able to withdraw uninvested funds at anytime for free, but you won’t earn any interest on your balance.</p>
        `
      },
      2: {
  ...
  cryptoLend: {
    contentHtml: `
      ...
      <h1 class="hightlight">Earn up to 9% APR.</h1>
      <h2>Invest BTC, ETH, and BNB.</h2>
      <h2 class="last">No fees, penalties, or lock-ups.</h2>
      <p>Invest your idle cryptocurrencies and get up to 9% APR. Unlock the best rate when you receive interest in PRV. Otherwise, earn {interest}% APY in BTC, ETH, or BNB, compounded and paid every second. Withdraw interest and principal anytime. All lending backed by MyConstant Guarantee<sup>1</sup>.</p>
  ...
  affiliates: {
    ...
    //   title:`
    //     <h2>Hello {name},</h2>
    //     <p><strong style="color:#F7B500;">Get $20</strong> for every person<sup>1</sup> you refer (no limits) plus <strong style="color:#F7B500;">20% of their Instant-access investment interest</strong> in their first year (capped at $1 million). Refer as many people as you like.</p>
    ...
    applyForm: {
      applyNow: 'Apply now',
      titleReward: `
        <h1 class="header">Get paid for your content.</h1>
        <p>Become a MyConstant affiliate and earn money on your content. <strong>Get \${affiliateReward}</strong><sup>1</sup> for every person<sup>2</sup> you refer plus <strong>20% of their Instant-access investment interest in their first year</strong> (capped at $1 million). Refer as many people as you like. </p>
        `,
      titleDescReward: `
    ...
    whyBecome: {
      ...
      formula: {
        ...
        '4': 'per registration',
        '5': ' ',
        '6': 'of referee’s Instant-access investment interest',
        '7': ' ',
        '8': 'for your referee',
      },
      // desc: '        <div class="section-desc-title">YOU EARN MORE</div>        <div><strong>Earn ${affiliateReward} for every US citizen who registers</strong>, paid instantly after they make their first deposit, and with no limits.</div>        <div><strong>Then earn 20% of their Instant-access investment interest</strong>, paid every second, and capped at a generous $1,000,000.</div>        <div><strong>Your referee also gets a ${kYCTrialAmount} Instant-access investing trial</strong> when they pass KYC. We’ll take the trial funds back at the end of the month, but they’ll keep the interest.</div>      ',
      // data: {
      //   '0': {
    ...
    howItWorks: {
      ...
      data: {
        ...
        '2': {
          title: ' ',
          desc: 'You get ${affiliateReward} paid instantly to your MyConstant account.'
        },
        '3': {
          title: ' ',
    ...
    faqs: {
      ...
      desc: 'Unlike traditional P2P platforms that prey on vulnerable borrowers and expect investors to shoulder the risk, MyConstant is designed to protect them both.'
    },
    terms: {
      content: `
        ...
        <ol>
          <li>
            ...
            <p class="desc">You earn 20% of your referees’ earned Instant-access investment interest. We pay this interest every second that your referees earn.</p>
          </li>
          ...
          <li><p>The maximum affiliate interest you can earn through Instant-access investing is $1,000,000.</p></li>
  ...
  yourReferral: {
    ...
    referralHistory: {
      ...
      affiliateTitle: 'Successful referral',
      headers: {
        email: 'Email',
    ...
    banner: {
      ...
      desc: `
        <p>Tell your friends and family about us and get \${referralReward} free for each person who signs up and deposits USD (US citizens only). You also earn <strong style="color:#F7B500;">{referralFlexReward}% of their Instant-access investment interest</strong>, compounded and paid every second. Refer as many friends as you like, however you like, and <strong style="color:#F7B500;">grow your money together</strong>.</p>
      `,
      titleNonUS: `
        <h1>Refer friends and earn <br/><span class="yellow">{referralFlexReward}% of their Instant-access investment interest</span></h1>
      `,
      descNonUS: `
        <p>Tell your friends and family about us and <strong style="color:#F7B500;">get {referralFlexReward}% of their Instant-access investment interest</strong> for each person who signs up and deposits USD. Refer as many friends as you like, however you like, and <strong style="color:#F7B500;">grow your money together</strong>.</p>
      `,
    ...
    youBothWin: {
      ...
      data: {
        ...
        2: {
          ...
          desc: 'Refer as many people as you like and <strong>get paid 10%</strong> on all their Instant-access investment earnings, capped at $1,000,000.',
        },
        3: {
    ...
    howItWorks: {
      ...
      data: {
        ...
        '2': {
          title: ' ',
          desc: 'You get ${referralReward} paid instantly to your MyConstant account.'
        },
        '3': {
          title: ' ',
      ...
      desc: '      <p>There are <strong>no limits</strong> to the number of people you can refer for the ${referralReward} bonus. Your Instant-access investment earnings earnings are capped at $1,000,000.</p>',
      descNonUS: '      <p>You <strong>earn {referralFlexReward}% of your friends\' earned Instant-access investment interest</strong> during their first year, capped at a generous $1,000,000.</p>'
    },
    terms: {
      normal: '        <h2 class="semiBold">Terms and Conditions</h2>        <ol>          <li><p>To qualify for the ${referralReward} bonus, your referee must be a US citizen.</p></li>          <li><p>The bonus is paid when your referee signs up, passes KYC, and deposits USD.</p></li>          <li><p>Your referral interest is calculated on the interest your friends earn with our Instant-access account.</p></li>          <li><p>Referral interest is paid to you by MyConstant and does not deduct from your friends’ earned Instant-access investment interest.</p></li>          <li>            <p>The amount you earn depends on how your friends use the platform:</p>            <p>You earn {referralFlexReward}% of your friends’ earned Instant-access investment interest during their first year. We pay this interest every second that your friends are earning. (Your friends can also refer others to boost your and their earnings, too).</p>          </li>          <li><p>You can invite as many friends as you like.</p></li>          <li><p>Your referral earnings are paid in USD, directly into your MyConstant account.</p></li>          <li><p>The maximum you can earn is $1,000,000.</p></li>          <li><p>You can’t self-invite by creating multiple accounts. If we detect such activity, all referrals and earnings (if any) will be forfeit.</p></li>          <li><p>When 365 days have passed following your friend’s sign-up, you’ll no longer earn on their Instant-access investment interest. For example, on the 366th day, you won\'t earn interest but on the 365th one you will.</p></li>          <li><p>For friends referred before the effective date (2020/02/17), you’ll earn on their Instant-access investment transactions after the effective date only.</p></li>          <li><p>MyConstant reserves the right to change the terms of the referral program at any time due to changing market conditions, risk of fraud, or any other factors we deem relevant.</p></li>        </ol>        <p class="bold effective">Effective as of {date}</p>      ',
      normalNonUS: `        <h2 class="semiBold">Terms and Conditions</h2>        <ol><li><p>Your reward is paid when your referee makes their first fiat deposit.</p></li>          <li><p>Your referral interest is calculated on the interest your friends earn with our Instant-access account.</p></li>          <li><p>Referral interest is paid to you by MyConstant and does not deduct from your friends’ earned Instant-access investment interest.</p></li>          <li>            <p>The amount you earn depends on how your friends use the platform:</p>            <p>You earn {referralFlexReward}% of your friends’ earned Instant-access investment interest during their first year. We pay this interest every second that your friends are earning. (Your friends can also refer others to boost your and their earnings, too).</p>          </li>          <li><p>You can invite as many friends as you like.</p></li>          <li><p>Your referral earnings are paid in USD, directly into your MyConstant account.</p></li>          <li><p>The maximum you can earn is $1,000,000.</p></li>          <li><p>You can’t self-invite by creating multiple accounts. If we detect such activity, all referrals and earnings (if any) will be forfeit.</p></li>          <li><p>When 365 days have passed following your friend’s sign-up, you’ll no longer earn on their Instant-access investment interest. For example, on the 366th day, you won't earn interest but on the 365th one you will.</p></li>          <li><p>For friends referred before the effective date (2020/02/17), you’ll earn on their Instant-access investment transactions after the effective date only.</p></li>          <li><p>MyConstant reserves the right to change the terms of the referral program at any time due to changing market conditions, risk of fraud, or any other factors we deem relevant.</p></li>        </ol>        <p class="bold effective">Effective as of {date}</p>      `,
    },
    materials: {
  ...
  landingPage: {
    ...
    luckySpin: {
      ...
      howItWorks: {
        ...
        data: {
          ...
          4: {
            ...
            desc: '<p>You can trade 1,000 membership points for 1 spin. The more membership points you spend, the more spins you get, the more prizes you earn.</p>',
          },
        },
      },
      intro: {
        ...
        desc: {
          ...
          3: 'Other prizes: Dog food on Feed & Give or extra spins.',
        },
      },
      finish: {
        contentHtml: `
      ...
      prizeHistory: {
        ...
        task: `{userName} got <span class="prize">+{reward}{unit}</span> for {action}.`,
      },
    },
  ...
  giftCard: {
    ...
    intro: {
      content: `
        ...
        <h1>Save <span class="hightlight">up to {rate}%</span> on gift cards*</h1>
        <h2>Choose from <span class="hightlight">{numCollateral}+ retailers</span>.</h2>
        <h2 class="last"><span class="hightlight">Instant</span> digital delivery.</h2>
