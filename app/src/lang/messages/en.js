    ...
    lendingSection: {
      ...
      intro: {
        content: `
            ...
            <h1 style="color:#F5A623;">Earn 20x more than a CD<sup>*</sup>.</h1>
  ...
  deposit: {
    ...
    faqs: {
      ...
      5: {
        ...
        answer: 'Flex uses an API with Compound Finance to lend your deposits to a liquidity pool. Others borrow from the pool in return for putting up collateral, and you earn the interest. In other words, Flex is very similar to how investments work on MyConstant, only with Flex you can withdraw anytime.',
      },
      6: {
      ...
      11: {
        ...
        answer: 'Flex deposits earn interest through an API with Compound Finance, another lending platform. Compound sets interest rates according to supply and demand, and MyConstant will make a slim profit on any difference between the Flex and Compound rates.'
      },
    },
  },
  depositFiat: {
  ...
  affiliates: {
    ...
    applyForm: {
      ...
      titleReward: `
        ...
        <p>Become a MyConstant affiliate and earn money on your content. <strong>Get \${affiliateReward}</strong><sup>1</sup> for every person<sup>2</sup> you refer plus <strong>20% of their Flex interest in their first year</strong> (capped at $1 million). Refer as many people as you like. </p>
        `,
      titleDescReward: `
